...
const SectionsSection = () => {
  const sections = [
    ...
    { number: "2", text: <>Цифровые технологии на предприятии <br />(модератор - В.Ф. Уколов)</>, link: "#" },
    { number: "3", text: <>Молодежная секция: брейншторм <br />(модератор - Д.И. Чистяков)</>, link: "#" },
    { number: "4", text: <>Цифровые технологии в управлении <br />(модераторы - О.П. Овчинникова,Т.В. Кокуйцева)</>, link: "#" }
  ];
