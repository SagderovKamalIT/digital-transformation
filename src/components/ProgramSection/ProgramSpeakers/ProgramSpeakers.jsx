...
export const speakersData  = [
  ...
  { name: "Квашин Александр Дмитриевич", src: kvashin, alt: "Квашин Александр", text: ["Директор по цифровизации."] },
...
export const speakersDataPart2 = [
   ...
   { name: "Константиниди Христофор Александрович", src: konstantin, alt: "Константиниди Христофор Александрович", text: ["Заведующий кафедрой туризма \nи сервиса \nВысшей школы управления РУДН."] },

     { name: "Гернеший Василий Васильевич", src: gerneshiy, alt: "Гернеший Василий Васильевич", text: ["Заместитель директора \nВысшей школы управления РУДН."] },

      { name: "Горяинов Константин Станиславович", src:  goryanov, alt: "Горяинов Константин Станиславович", text: ["Исполнительный директор ООО «Сафмар плаза».", "Генеральный менеджер отеля «Националь»."] },


        { name: "Тимохов Федор Дмитриевич", src: gerneshiyV, alt: "Тимохов Федор Дмитриевич", text: ["Менеджер по продвижению TraveiLine." ]}
